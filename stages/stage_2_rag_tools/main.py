...
LEGAL_KNOWLEDGE = [
    ...
    },
    {
        ...
        "text": (
            ...
            "Trợ cấp thôi việc: 1/2 tháng lương cho mỗi năm làm việc (tối thiểu)."
        ),
    },
]
...
def check_statute_of_limitations(case_type: str) -> str:
    ...
    limits = {
        ...
        "property": "5 năm",
        "labor": "2 năm (Bộ luật Lao động Việt Nam) hoặc 3 năm với khiếu nại lương",
    }
    return limits.get(case_type.lower(), "Không xác định — vui lòng tham khảo luật sư")
